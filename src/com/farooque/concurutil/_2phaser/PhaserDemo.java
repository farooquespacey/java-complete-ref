...
class PhaserDemo {
	public static void main(String args[]) {
		...
		System.out.println(Thread.currentThread().getName() + " Beginning Phase One");
		phsr.arriveAndAwaitAdvance();
		System.out.println("Phase " + curPhase + " Complete");

		// Wait for all threads to complete phase two.
		curPhase = phsr.getPhase();
		System.out.println(Thread.currentThread().getName() + " Beginning Phase Two");
		phsr.arriveAndAwaitAdvance();
		System.out.println("Phase " + curPhase + " Complete");

		curPhase = phsr.getPhase();
		System.out.println(Thread.currentThread().getName() + " Beginning Phase Three");
		phsr.arriveAndAwaitAdvance();
		System.out.println("Phase " + curPhase + " Complete");
